...
synthetic inputs would be AJ007 findings there; and the soil-water and PET packages are frozen
while the H1 hardening changes them. Discovery (:mod:`..discover`) reads this list and the
``agrijax.conformance`` entry points through the same path.
"""

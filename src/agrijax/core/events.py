...
:func:`agrijax.core.organs.prime`); days without priming carry ``-1, -1``, an empty range, so
...
class EventTable(Forcing):
    ...
    def from_csv(
        ...
        *,
        ...
        (:data:`agrijax.io.catpa.EVENT_COLUMNS`). Kinds in ``ignore`` (pesticide and tillage

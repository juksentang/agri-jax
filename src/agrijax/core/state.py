...
The within-crop organ queue :class:`~agrijax.core.organs.OrganQueue` (section 3.7) lives in
``agrijax.core.organs`` and is re-exported here (lazily, since it builds on :func:`field`).
"""

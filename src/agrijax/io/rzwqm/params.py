...
write-back, going through :func:`~agrijax.io.rzwqm.dat.set_value` (GenerateDat formatting).
"""
...
def params_from_dat(dat: RzwqmDat, param_map: Iterable[ParamSpec] | None = None) -> dict[str, np.ndarray]:
    ...
    Keys: every name of :data:`~agrijax.io.rzwqm.dat.HYDRAULIC_FIELDS` (arrays over all

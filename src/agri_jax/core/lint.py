"""Standalone AST lint for the three process rules (docs/en/05_maintenance_pipeline.md section 3).
...
Usage::
    ...
    python -m agri_jax.core.lint src/agri_jax/processes [--all] [--strict]
"""
...
def main(argv: Sequence[str] | None = None) -> int:
    ap = argparse.ArgumentParser(prog="agri_jax.core.lint", description=(__doc__ or "").split("\n\n")[0])
    ...
    print(
        f"agri_jax lint: {n_err} error(s), {n_warn} warning(s) in {len(visited)} function(s) "
